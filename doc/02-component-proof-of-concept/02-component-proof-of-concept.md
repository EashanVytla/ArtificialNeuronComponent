...
- **Name**: Eashan Vylta<!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment -->
- **Dot Number**: Vytla.4<!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
...
I chose the ArtificialNeuron design with a getter and setting design and private member variables. I thought this was the best design because it keeps the members safe from bugs as they must pass many checks when getting and setting them.
